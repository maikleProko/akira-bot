from classes.ocr.abstracts.AxisImporter import AxisImporter
from classes.ocr.abstracts.PaneImporter import PaneImporter



class ChartParser(AxisImporter, PaneImporter):
    def __init__(self):
        AxisImporter.__init__(self)
        PaneImporter.__init__(self)
        self.run()

    def get_dimension_of_chart(self):
    ...
    def run(self):
        try:
            ...
            self.get_pane_data()
            self.restore_pane_data(self.axis_y_begin, self.axis_y_end)
