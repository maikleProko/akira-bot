...
class KamaStrategy(Strategy):
    def __init__(
            ...
            kama_indicator_5m: KamaIndicator,
            kama_indicator_3m: KamaIndicator,
        ...
        self.kama_indicator_5m = kama_indicator_5m
        self.kama_indicator_3m = kama_indicator_3m
    ...
    def is_correct_kamas(self):
        return self.is_small_trend_kama(self.kama_indicator_1m) and self.is_small_trend_kama(self.kama_indicator_3m) and self.is_small_trend_kama(self.kama_indicator_5m) and self.is_small_trend_kama(self.kama_indicator_15m) and self.is_small_trend_kama(self.kama_indicator_60m) and self.is_small_trend_kama(self.kama_indicator_120m)
