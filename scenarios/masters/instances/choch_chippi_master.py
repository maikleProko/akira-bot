...
from scenarios.strategies.instances.choch_chippi_strategy import CHoCHChippiStrategy
import mexc_api


class CHoCHChippiMaster(MarketMaster):
    def __init__(self, symbol1, symbol2, balance_usdt, mode='generating',
        ...
        supertrend_indicator_15m = SupertrendIndicator(history_market_parser_15m)
        supertrend_indicator_1m = SupertrendIndicator(history_market_parser_1m)
        ...
        strategy = CHoCHChippiStrategy(
            history_market_parser_1m=history_market_parser_1m,
            kama_indicator_120m=kama_indicator_120m,
            supertrend_indicator_15m=supertrend_indicator_15m,
            supertrend_indicator_1m=supertrend_indicator_1m,
        ...
        self.market_processes = [
            ...
            kama_indicator_15m,
            kama_indicator_120m,
            supertrend_indicator_15m,
            supertrend_indicator_1m,
            choch_indicator_1m,
